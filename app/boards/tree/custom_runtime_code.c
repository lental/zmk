...
static int zmk_peripheral_ble_complete_startup(void) {
	printk("HEllooo tree completstartup?\n");
	...
	printk("HEllooo tree unpair?\n");
     	bt_unpair(BT_ID_DEFAULT, NULL);
	}
	printk("HEllooo tree complete_startup prereturn\n");
    return 0;
}
